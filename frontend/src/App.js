...
// 1. 서버로 소켓 conncet 요청
const socket = io.connect("http://127.0.0.1:15000");
...
//             const link = {
//                 name: file.name,
//                 url: URL.createObjectURL(new Blob([file.data]))
//             };
//             setFileLinks((links) => links.concat(link));
//         });
//     }, []);
//
...
//                     <button onClick={handleFileUpload}>파일 전송</button>
//                 </div>
//             </div>
//         </div>
//     );
